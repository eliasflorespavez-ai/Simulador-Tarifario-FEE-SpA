...
def main(page: ft.Page):
    ...
    # Base de datos completa y fidedigna (Valores Netos)
    tarifas_netas = {
    ...
    dlg_info = ft.AlertDialog(
        title=ft.Text("Desglose de Cálculo"),
    ...
    def calcular(e):
        try:
            ...
            neto = kwh * val_neto # Cuadra con los $29.710 para 126kWh
            iva = neto * 0.19
            total_mes = neto + iva
            ...
            res_card.content.controls.extend([
                ...
                ft.Divider(),
                ft.Row([ft.Text("Saldo Anterior (Deuda):"), ft.Text(f"${int(deuda):,}", color="red")], alignment="spaceBetween"),
                ft.Row([
    ...
    page.add(
        ft.Column([
            ...
            res_card,
            ft.Container(height=40), # Espaciador para la firma
